...
<span>
    ...
    <v-form>
        ...
        <v-btn @click="toggleStartTimePicker" class="ma-2">Select Start Time</v-btn>
        ...
        <v-btn @click="toggleEndTimePicker" class="ma-2">Select End Time</v-btn>
...
export default{
    ...
    methods: {
        ...
        saveEvent(){
            ...
            console.log(event)
            // let eventRequest = {event: event, users: this.friendObjectList};
